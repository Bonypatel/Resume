...
\begin{cventries}
    ...
    {Aug. 2024 - Present}
    {
      \begin{cvitems}
        ...
        \item {Contributing new functionality to internal libraries for enhanced Permissioning, OAuth 2.0 Authentication, and Database interfacing to streamline implementation in new environments and tools}
        \item {Develop Add-Ins for Microsoft Word, Outlook and Teams which used the CobbleStone REST API for backend functionality and Javascript for the frontend}
