...
\begin{cventries}
    ...
    {Aug. 2024 - Present}
    {
      \begin{cvitems}
        ...
        \item {Refactor and migrate existing API endpoints to .NET Core to enhance performance, scalability, and security}
        \item {Contribute new functionality to internal libraries for enhanced Permissioning, OAuth 2.0 Authentication, and Database interfacing to streamline implementation in new environments and tools}
        \item {Develop add-ins-Ins for Microsoft Word, Outlook and Teams which used the CobbleStone REST API for backend functionality and Javascript for the frontend}
